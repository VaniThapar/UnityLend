...
public class UserServiceImpl implements UserService {
    ...
    public User getUserByUserId(String userId) throws ServiceException {
        try {
            ...
            log.error("Error encountered while getting user by user id");
            throw new ServiceException("Error encountered while getting user by user id", e);
        }
    }
    ...
    private void mapUserToCommunity(String userId, List<String> commonTags) {
        ...
        for (String commonTag : commonTags) {
            userCommunityMapRepository.createUserCommunityMapping(userId, communityRepository.getCommunityIdByName(commonTag));
        }
    }
    ...
    public void updateUser(User user, String userId) throws ServiceException {
        ...
        try {
            userCommunityMapRepository.deletePrevData(userId);
